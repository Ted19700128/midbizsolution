...
urlpatterns = [    
    ...
    path('pemledger/get_line_shapes/', views.get_line_shapes, name='get_line_shapes'),
    path('pemledger/get_equipment_data/', views.get_equipment_data, name='get_equipment_data'),
