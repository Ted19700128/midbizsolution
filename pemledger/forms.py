...
class EquipmentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'first_install': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'first_implement': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        optional_fields = [        
            'mfg_date', 'equipment_type', 'specs', 'first_implement', 'overhaul'
        ]
